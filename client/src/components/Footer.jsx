    ...
    >
      ...
      >
        <div>
          ...
          >
            <a href="#">
              <img src={assets.facebook_logo} className="size-5" alt="" />
            </a>
            <a href="#">
              <img src={assets.instagram_logo} className="size-5" alt="" />
            </a>
            <a href="#">
              <img src={assets.twitter_logo} className="size-5" alt="" />
            </a>
            <a href="#">
              <img src={assets.gmail_logo} className="size-5" alt="" />
            </a>
          </motion.div>
        </div>
